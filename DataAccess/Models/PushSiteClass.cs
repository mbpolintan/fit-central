...
{
    public partial class PushSiteClass
    {
        public PushSiteClass()
        {
            PushSiteClassResource = new HashSet<PushSiteClassResource>();
        }
        ...
        public virtual ICollection<PushSiteClassResource> PushSiteClassResource { get; set; }
    }
}
